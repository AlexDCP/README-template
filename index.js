...
const questions = [title, description, toc, install, usage, license, contribution, test, questions];
...
inquirer
    .prompt([
        ...
        {
            type: 'input',
            message: 'List any contributors who may have helped you with the project, and a link to their github:',
            name: 'contribution',
        },
        {
            type: 'input',
